...
class BaseService(ABC):
    ...
    async def get_object_by_id(self, object_id:int)->object|HTTPException:
    ...
    async def update_put(self, session: AsyncSession,  object_id:int ,update_data: dict[str, Any]):
        ...
        updated_obj = await self.get_object_by_id(session, object_id) # проверка на существвание в БД
